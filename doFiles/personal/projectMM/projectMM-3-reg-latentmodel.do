...
****************************************************************************************************
	...
	*loc xit2 "c.d_count#c.age c.d_count#c.age#c.age" // how to include linear interactions of types with d_count?
	...
	gl zit_0 "i.rabyeargrp i.ageatfirstobs " // d_count
...
log using 		"$outpath/logs/log-t-regd_count-age-fmmologit`data'2.txt", text replace name(log) 
di "$y $xit $zit_0"
fmm 2, lcprob($zit_0) : ologit $y $xit
log close log
