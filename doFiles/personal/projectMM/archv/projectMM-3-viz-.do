...
// 	logit 		alive i.time if cohortmin5==50
// 	margins 	time
// 	marginsplot, noci
//	
	preserve 
	...
	stdes	
		...
		sts graph if cohortmin5==50, survival by(c) legend(pos(6) rows(3))
	restore 
	pause
...
gr export 	"$outpath/fig/main/g_logit_byage-male-`sample'-alld.pdf", replace // quality(100)
